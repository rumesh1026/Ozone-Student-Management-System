...
<head>
    <meta charset="UTF-8">
    <title><c:choose><c:when test="${student != null}">Edit Student</c:when><c:otherwise>Add Student</c:otherwise></c:choose> - Ozone Institute</title>
...
<main class="max-w-lg mx-auto py-10 px-4">
    <div class="bg-white rounded-lg shadow-lg p-8">
        ...
        <form action="<%=request.getContextPath()%>/students/${student != null ? 'update' : 'add'}" method="post" class="space-y-5">
            ...
            <div>
                <label for="joinDate" class="block text-gray-700 font-medium mb-1">Join Date</label>
                <input type="date" id="joinDate" name="joinDate" required
                       value="<c:out value='${student != null ? student.joinDate : ""}'/>"
                       class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
